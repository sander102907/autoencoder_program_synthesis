"""
Official pytorch AdaptiveLogSoftmaxWithLoss implementation:
https://pytorch.org/docs/stable/_modules/torch/nn/modules/adaptive.html#AdaptiveLogSoftmaxWithLoss

However, instead of reducing the loss to the mean, no reduction is applied now and hence the reduction can be applied afterwards
